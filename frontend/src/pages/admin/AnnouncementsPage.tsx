            ...
            {!editingId && (
              <div style={{ marginBottom: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
                  ...
                  <button type="button" onClick={() => setForm({ ...form, title: 'Fee Payment Reminder - Overdue', body: 'Dear Parents,\n\nThis is a gentle reminder that the fee payment of ₹[AMOUNT] was due on [DATE].\n\nKindly clear the outstanding amount at the earliest to avoid any inconvenience. Please visit the school office or use online payment.\n\nIf already paid, kindly ignore this message.\n\nThank you.' })} style={templateBtn}>💰 Fee Reminder</button>
